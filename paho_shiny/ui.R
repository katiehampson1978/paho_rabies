...
fluidRow(column(width = 2, br(), downloadButton("download","Download Article")),
    column(width = 7, uiOutput("titleinfo")), 
           column(width = 1, br(), actionButton("help", label = "Help", icon = icon("question",lib = "font-awesome"))),
           column(width = 2, br(), actionButton("reset_map", "Reset", icon = icon("refresh", lib = "glyphicon")))),
  br(),
  fluidRow(
    column(width = 5, 
